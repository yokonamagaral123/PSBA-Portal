...
const AdminRequisitionHistory = () => {
  ...
  return (
    <>
      <div className="admin-requisition-history-banner">
        <h1 className="admin-requisition-history-banner-title">ADMIN REQUISITION HISTORY</h1>
      </div>
      <div className="admin-requisition-history-content">
