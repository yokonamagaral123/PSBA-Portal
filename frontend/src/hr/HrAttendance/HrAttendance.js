...
const HrAttendance = () => {
  ...
  return (
    <>
      {/* Attendance Banner */}
      <div className="hr-attendance-banner">
        <h1 className="hr-attendance-banner-title">ATTENDANCE</h1>
      </div>
      <div className="hr-attendance-filter-row">
        <div className="hr-attendance-log-btn-container">
          <button
            className="hr-attendance-log-btn"
        ...
        />
        <button
          className="hr-attendance-reset-btn"
          title="Reset filters"
          onClick={() => {
            setStartDate("");
            setEndDate("");
        ...
        <div
          className="hr-attendance-pagination-bar"
          style={{ marginLeft: "auto" }}
        >
          <button
            onClick={() => goToPage(Math.max(1, currentPage - 10))}
            disabled={currentPage === 1}
            className="hr-attendance-page-btn"
          >
            {"<<"}
          </button>
          <button
          ...
          {getPageNumbers().map((page) => (
            <button
              ...
              className={`hr-attendance-page-btn${
                page === currentPage ? " hr-attendance-page-current" : ""
              }`}
      ...
      {showClockModal && (
        <div className="hr-attendance-modal-overlay">
          <div className="hr-attendance-modal">
            <button
              className="hr-attendance-modal-close"
              onClick={() => setShowClockModal(false)}
            >
              &times;
            </button>
            <div className="hr-attendance-clock-day">
              {clock
                .toLocaleDateString(undefined, { weekday: "long" })
                .toUpperCase()}
            </div>
            <div className="hr-attendance-clock-time">
              {clock.toLocaleTimeString([], { hour12: false })}
            </div>
            <div className="hr-attendance-clock-date">
            ...
            <div className="hr-attendance-clock-btn-row">
              <button
                className="hr-attendance-clock-action-btn"
