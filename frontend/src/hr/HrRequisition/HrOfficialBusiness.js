...
import "./HrOfficialBusiness.css";

const HrOfficialBusiness = () => {
  ...
  return (
    <>
      <div className="hr-ob-banner">
        <h1 className="hr-ob-banner-title">OFFICIAL BUSINESS</h1>
      </div>
      <div className="hr-ob-content">
        <h1>Official Business</h1>
        <form onSubmit={handleSubmit}>
          <div className="hr-ob-row">
            <div className="hr-ob-field">
          ...
          <div className="hr-ob-reason-container">
          ...
          <div className="hr-ob-submit-container">
...
export default HrOfficialBusiness;
